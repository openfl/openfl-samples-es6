...
class App extends Sprite {
	...
	static DAMPING = 1.09;
	static LINEAR_ACCELERATION = 0.0005;
	static MAX_FORWARD_VELOCITY = 0.05;
	static MAX_ROTATION_VELOCITY = 0.5;
	static ROTATION_ACCELERATION = 0.01;
	...
	calculateUpdatedVelocity (curVelocity, curAcceleration, maxVelocity) {
	...
	uploadTextureWithMipMaps (texture, originalImage) {
