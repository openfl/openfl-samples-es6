...
export class PiratePigGame extends Sprite {
	...
	static tileImages = [ "images/game_bear.png", "images/game_bunny_02.png", "images/game_carrot.png", "images/game_lemon.png", "images/game_panda.png", "images/game_piratePig.png" ];
	...
	addTile (row, column, animate = true) {
	...
	findMatches (byRow, accumulateScore = true) {
	...
	removeTile (row, column, animate = true) {
	...
	swapTile (tile, targetRow, targetColumn) {
	...
	gameInput_onDeviceRemoved = (event) => {
	...
	TileContainer_onMouseDown = (event) => {
